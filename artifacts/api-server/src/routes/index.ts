...
import problemListRouter from "./problem-list";
import tasksRouter from "./tasks";
import appointmentClaimsRouter from "./appointment-claims";
...
router.use(problemListRouter);
router.use(ordersRouter);
router.use(tasksRouter);
router.use(scheduleRouter);
router.use(recordingsRouter);
router.use(ehrOauthRouter);
router.use(appointmentClaimsRouter);
